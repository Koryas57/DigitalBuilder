export const audiencePaths = [
  ...
  },
  {
    ...
    title: "Sites Web",
    intro: "Je veux découvrir vos sites et expériences digitales",
    items: ["Sites web premium", "Commerces locaux", "Parcours de conversion", "Projets réellement contextualisés"],
    accent: "gold",
    icon: "cart",
