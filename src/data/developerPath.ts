...
export const developerStations: DeveloperStationData[] = [
  {
    ...
    relatedProjects: ["TravelTactik", "Vitrine Express", "Mode Immersion"],
    visualType: "orb",
    position: { x: 50, y: 18 },
  ...
  },
  {
    ...
    relatedProjects: ["Vitrine Express", "Mode Immersion", "Applications web"],
    visualType: "grid",
    position: { x: 78, y: 34 },
  ...
  },
  {
    ...
    relatedProjects: ["Applications web", "Outils & automatisations", "TravelTactik"],
    visualType: "terminal",
    position: { x: 80, y: 68 },
  ...
  },
  {
    ...
    relatedProjects: ["Nagara", "Mode Immersion", "Experiences immersives"],
    visualType: "orb",
    position: { x: 22, y: 66 },
  ...
  },
  {
    ...
    relatedProjects: ["Mode Immersion", "Outils & automatisations", "Applications web"],
    visualType: "terminal",
    position: { x: 22, y: 34 },
...
export const developerQuickSummary = {
  ...
  projects: ["TravelTactik", "Vitrine Express", "Mode Immersion", "Applications web"],
};
