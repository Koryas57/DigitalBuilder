...
export const developerStations: DeveloperStationData[] = [
  {
    ...
    relatedProjects: ["TravelTactik", "Bien en ligne", "Mode Immersion"],
    visualType: "orb",
    position: { x: 50, y: 18 },
  ...
  },
  {
    ...
    relatedProjects: ["Bien en ligne", "Mode Immersion", "Applications web"],
    visualType: "grid",
    position: { x: 78, y: 34 },
...
export const developerQuickSummary = {
  ...
  projects: ["TravelTactik", "Bien en ligne", "Mode Immersion", "Applications web"],
};
